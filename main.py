...
def db2_keep_alive(request):
    ...
    try:
        ...
        record_count_val = ibm_db.num_rows(stmt_cleanup) # ✅ 使用正确的函数 ibm_db.num_rows()
    ...
    return jsonify(response_payload), 200 if status_val == "OK" or status_val == "LOG_FAIL" else 500